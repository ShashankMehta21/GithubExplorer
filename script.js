// let githubUsername = "ShashankMehta21";
const clearPreviousData = () => {
    document.querySelector('.profile').src = ''; // Clear profile image
    document.querySelector('.profile-name').textContent = ''; // Clear name
    document.querySelector('.username').textContent = ''; // Clear username
    document.querySelector('.repos').textContent = ''; // Clear repository count
    document.querySelector('.followers').textContent = ''; // Clear followers
    document.querySelector('.following').textContent = ''; // Clear following
    document.querySelector('.creation-date').textContent = ''; // Clear creation date
    document.querySelector('.all-repos').innerHTML = ''; // Clear repositories list
    const rightBox = document.querySelector('.right-box');
    rightBox.querySelectorAll('div:not(:first-child)').forEach(div => div.remove()); // Remove dynamic bio, location, etc.
}
